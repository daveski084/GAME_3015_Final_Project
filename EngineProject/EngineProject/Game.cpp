...
Game::Game(HINSTANCE hInstance): D3DApp(hInstance), mStateStack(State::Context(mPlayer, *this)) {}
...
void Game::UpdateObjectCBs(std::vector<std::unique_ptr<RenderItem>>& allrenderitems)
{
...
void Game::LoadTextures()
{
	...
	TitleTex->Filename = L"../../Textures/TITLESTATE2.dds";
	ThrowIfFailed(DirectX::CreateDDSTextureFromFile12(md3dDevice.Get(),
	...
	MenuTex->Filename = L"../../Textures/Menustate2.dds";
	ThrowIfFailed(DirectX::CreateDDSTextureFromFile12(md3dDevice.Get(),
	...
	GameUITex->Filename = L"../../Textures/Menustate2.dds";
	ThrowIfFailed(DirectX::CreateDDSTextureFromFile12(md3dDevice.Get(),
...
void Game::BuildRenderItems(std::vector < std::unique_ptr<RenderItem >> &allrenderitems)
{
	// build world
	// mWorld.buildScene();
